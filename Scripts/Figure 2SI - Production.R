...
ggsave("Figures/SI/Fig_Production_Demand.png", p_prod_demand, units = "cm", dpi = 600, width = 8.7, height = 8.7)
...
dir.create("Figures/Data_Figures", recursive = TRUE, showWarnings = FALSE)
...
ggsave("Figures/Fig_Production_Biodiversity.png", p_prod_biod, units = "cm", dpi = 600, width = 8.7, height = 8.7)
